        ...
        <div className="bg-slate-900/80 backdrop-blur-xl rounded-2xl md:rounded-3xl shadow-2xl border border-slate-800/50 overflow-hidden animate-scale-in">
          <div className="grid md:grid-cols-2">
            ...
            <div className="p-8 md:p-10 lg:p-12">
              ...
              {/* OAuth — voie principale : évite l'e-mail de confirmation.
                  Sur iPhone/iPad, Apple passe devant Google. */}
              {(() => {
                const appleBtn = (
                  <Button
                    key="apple"
                    ...
                    className={
                      isIOS
                        ? 'w-full h-12 text-base font-semibold bg-white text-slate-900 hover:bg-slate-100 shadow-lg'
                        : 'w-full h-11 text-base font-medium bg-transparent text-white border-slate-700 hover:bg-slate-800'
                    }
