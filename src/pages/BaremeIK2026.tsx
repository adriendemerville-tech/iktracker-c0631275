...
const faqData = [
  {
    ...
    answer:
      "Le barème kilométrique 2026 est identique au barème 2024, inchangé pour 2025 et 2026. Il prévoit des taux allant de 0,529 €/km pour un véhicule de 3 CV jusqu'à 5000 km, à 0,401 €/km pour un véhicule de 7 CV et plus au-delà de 20 000 km.",
  },
  {
    question: "Comment calculer ses indemnités kilométriques ?",
    answer:
      "Pour calculer vos IK, multipliez le nombre de kilomètres professionnels parcourus par le taux correspondant à la puissance fiscale de votre véhicule et à votre tranche kilométrique (jusqu'à 5000 km, de 5001 à 20000 km, ou plus de 20000 km).",
  },
  {
    question: "Les véhicules électriques bénéficient-ils d'un avantage ?",
    answer:
      "Oui, les véhicules 100% électriques bénéficient d'une majoration de 20% sur le barème kilométrique. Cette mesure vise à encourager la transition vers des véhicules moins polluants.",
  },
  {
    question: "Quelle différence entre frais réels et indemnités kilométriques ?",
    answer:
      "Les indemnités kilométriques sont calculées selon un barème forfaitaire qui couvre tous les frais (carburant, entretien, assurance, dépréciation). Les frais réels nécessitent de justifier chaque dépense individuellement avec des factures.",
  },
  {
    question: "Dois-je tenir un carnet de bord pour mes trajets professionnels ?",
    answer:
      "Oui, en cas de contrôle fiscal, vous devez pouvoir justifier vos déplacements professionnels. Un relevé précis (date, motif, destination, distance) est recommandé. IKtracker automatise cette tâche pour vous.",
  },
  {
    question:
      "Pourquoi les indemnités kilométriques sont-elles importantes pour les indépendants ?",
    answer:
      "Les indépendants supportent seuls tous les frais liés à l'usage de leur véhicule personnel : carburant lourdement taxé (TICPE), assurance, entretien (pneus, freins, vidange) et dépréciation du véhicule (15 à 20 % de perte de valeur la première année). Le barème IK compense forfaitairement l'ensemble de ces coûts et évite une amputation significative du revenu net.",
  },
  {
    question: "Combien de kilomètres les utilisateurs d'IKtracker enregistrent-ils ?",
    answer:
      "Sur la plateforme IKtracker, les utilisateurs les plus mobiles enregistrent jusqu'à 5 900 km par mois. En moyenne, chaque utilisateur cumule environ 4 886 km de trajets professionnels. Le montant maximum d'IK comptabilisé par un seul utilisateur dépasse 58 000 €, avec une moyenne de 2 730 € par utilisateur.",
  },
  {
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            about: {
              ...
              description:
                "Barème fiscal officiel pour le calcul des frais de déplacement professionnels",
            },
          })}
        </script>
        {/* FAQ Schema */}
        ...
        <script type="application/ld+json">
          {JSON.stringify(
            buildSoftwareApplicationSchema({
              pageUrl: "https://iktracker.fr/bareme-ik-2026",
              pageDescription:
                "Barème kilométrique 2026 officiel URSSAF : tableau par CV, simulateur gratuit, majoration +20% véhicule électrique. Outil communautaire gratuit à vie, conçu par un entrepreneur indépendant.",
            }),
          )}
        </script>
      </Helmet>
              ...
              <nav aria-label="Sommaire" className="mt-10 max-w-xl mx-auto">
                <div className="bg-muted/50 border border-border rounded-xl p-5">
                  ...
                  <ol className="space-y-2 text-sm list-decimal list-inside">
                    ...
                    <li>
                      <a href="#tableau-voitures" className="text-primary hover:underline">
                        Tableaux barème officiel
                      </a>
                    </li>
                    <li>
                      <a href="#pourquoi-ik" className="text-primary hover:underline">
                        Pourquoi les IK sont indispensables
                      </a>
                    </li>
                    <li>
                      <a href="#donnees-communaute" className="text-primary hover:underline">
                        Données de la communauté IKtracker
                      </a>
                    </li>
                    <li>
                      <a href="#vehicules-electriques" className="text-primary hover:underline">
            ...
            <div className="container mx-auto max-w-4xl">
              <Card className="border-amber-500/20 bg-amber-50/50 dark:bg-amber-950/20">
                ...
                <CardContent className="space-y-4 text-foreground">
                  <p>
                    <strong>
                      Le barème des indemnités kilométriques 2026 est le barème officiel applicable.
                    </strong>{" "}
                    Ces taux, publiés par l'{" "}
                    <a
                    ...
                    , permettent aux contribuables de calculer leurs frais de déplacement
                    professionnels pour leurs déclarations fiscales.
                  </p>
                  ...
                  <div className="grid md:grid-cols-2 gap-4 mt-6">
                    <div className="bg-background rounded-xl p-4 border border-border">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Depuis 2024, les prix à la pompe se sont stabilisés après les fortes hausses
                        de 2022-2023. Cette accalmie ne justifie pas une revalorisation du barème
                        aux yeux de l'administration fiscale.
                      </p>
                    </div>
                    ...
                    <div className="bg-background rounded-xl p-4 border border-border">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Les difficultés budgétaires de l'État n'incitent pas à revaloriser les IK.
                        En effet, des taux plus élevés représenteraient un manque à gagner fiscal
            ...
            <div className="container mx-auto max-w-4xl">
              <div className="text-center mb-8">
                ...
                <p className="text-muted-foreground">
                  Voici le <strong>barème des IK 2026</strong> officiel avec les taux par puissance
                  fiscale et kilomètres parcourus.
                </p>
              </div>
                ...
                <CardContent className="p-0 overflow-x-auto">
                  <Table aria-label="Barème des indemnités kilométriques 2026">
                    <caption className="sr-only">
                      Tableau des taux d'indemnités kilométriques par puissance fiscale et distance
                      parcourue
                    </caption>
                    <TableHeader>
              ...
              <Card>
                <CardContent className="p-0 overflow-x-auto">
                  <Table aria-label="Barème des indemnités kilométriques 2026 pour motos">
                    <caption className="sr-only">
                      Tableau des taux d'indemnités kilométriques pour motos par puissance fiscale
                    ...
                    <TableBody>
                      <TableRow className="bg-background">
                        <TableCell scope="row" className="font-semibold">
                          <div className="flex items-center gap-2">
                            <Bike className="h-4 w-4 text-primary" aria-hidden="true" />1 ou 2 CV
                          </div>
                        </TableCell>
                        <TableCell className="text-center">
                          <code className="bg-primary/10 text-primary px-2 py-1 rounded text-sm font-mono">
              ...
              <div className="text-center mb-8 mt-16">
                ...
                <p className="text-muted-foreground">
                  Voici le <strong>barème des IK 2026 pour les cyclomoteurs</strong> et scooters de
                  moins de 50 cm³.
                </p>
              </div>
              ...
              <Card>
                <CardContent className="p-0 overflow-x-auto">
                  <Table aria-label="Barème des indemnités kilométriques 2026 pour cyclomoteurs">
                    <caption className="sr-only">
                      Tableau des taux d'indemnités kilométriques pour cyclomoteurs par distance
                      parcourue
                    </caption>
                    <TableHeader>
                      <TableRow className="bg-muted/50">
          ...
          >
            <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 prose prose-lg dark:prose-invert">
              ...
              <h3 className="text-xl font-semibold mt-6 mb-3">
                Le carburant : un poste lourdement taxé
              </h3>
              <p>
                Lorsqu'un travailleur indépendant — qu'il soit consultant,{" "}
                <a
                ...
                , commercial ou artisan — utilise son <strong>véhicule personnel</strong> pour se
                rendre chez ses clients ou sur ses chantiers, il supporte seul l'intégralité des
                coûts associés à ces déplacements. Contrairement à un salarié d'une grande
                entreprise disposant d'un véhicule de fonction, l'indépendant avance{" "}
                <strong>le carburant, lourdement taxé</strong> (la{" "}
                <a
                  href="https://www.ecologie.gouv.fr/fiscalite-des-energies"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-primary hover:underline"
                >
                ...
                représente environ 60 centimes par litre d'essence), paie son assurance auto,
                finance les révisions et les réparations courantes (pneus, freins, vidange). La page{" "}
                <Link to="/frais-reels" className="text-primary hover:underline">
                  frais réels vs barème IK
                </Link>{" "}
                détaille les différences entre ces deux régimes. Le cas particulier des{" "}
                <Link to="/artisans" className="text-primary hover:underline">
                  frais kilométriques d'un artisan du bâtiment
                </Link>
                , avec ses allers-retours entre dépôt, chantiers et négoce, est traité sur une page
                dédiée.
              </p>
              <h3 className="text-xl font-semibold mt-6 mb-3">
                Usure, entretien et dépréciation du véhicule
              </h3>
              <p>
                Au-delà du carburant, l'indépendant subit la <strong>dépréciation naturelle</strong>{" "}
                de son véhicule, qui perd en moyenne 15 à 20 % de sa valeur dès la première année.
                Le{" "}
                <a
                ...
                existe précisément pour compenser forfaitairement l'ensemble de ces frais réels :
                usure mécanique, consommation de carburant, entretien régulier et perte de valeur du
                véhicule. Sans ce dispositif fiscal, des centaines de milliers de professionnels
                mobiles verraient leur revenu net amputé de plusieurs milliers d'euros chaque année.
              </p>

              <h2
                id="donnees-communaute"
                className="text-2xl md:text-3xl font-bold mb-6 mt-12 flex items-center gap-3"
              >
              ...
              <p>
                ...
                dans le suivi quotidien de leurs déplacements professionnels. Les données agrégées
                et anonymisées de la plateforme offrent un aperçu concret de la réalité terrain des
                indépendants français. En termes de volume, les utilisateurs les plus mobiles
                enregistrent jusqu'à <strong>5 900 km par mois</strong>, soit l'équivalent d'un
                aller-retour Paris–Bucarest chaque mois. Le{" "}
                <Link to="/mode-tournee" className="text-primary hover:underline">
                  mode tournée GPS
                </Link>{" "}
                permet de suivre ces trajets en temps réel.
              </p>
              <h3 className="text-xl font-semibold mt-6 mb-3">
                Des montants qui parlent d'eux-mêmes
              </h3>
              <p>
                Sur l'ensemble de la plateforme, le{" "}
                <strong>montant maximum d'indemnités kilométriques</strong> comptabilisé par un seul
                utilisateur dépasse <strong>58 000 €</strong>, ce qui illustre l'ampleur des
                déplacements dans certaines professions itinérantes. En moyenne, chaque utilisateur
                a cumulé environ <strong>2 730 € d'IK</strong>, pour une distance moyenne de{" "}
                <strong>4 886 km</strong> enregistrés. Au total, plus de{" "}
                <strong>4 600 trajets professionnels</strong> ont été documentés sur la plateforme.
                Ces chiffres démontrent que les indemnités kilométriques ne sont pas un avantage
                symbolique : elles représentent un levier fiscal majeur pour les professionnels qui
                sillonnent les routes de France au quotidien. Découvrez comment{" "}
                <Link to="/expert-comptable" className="text-primary hover:underline">
                  exporter vos IK pour votre comptable
                </Link>
                .
              </p>
              ...
              <h3 className="text-xl font-semibold mt-6 mb-3">
                Le risque fiscal de l'oubli de trajets
              </h3>
              <p>
                L'un des pièges les plus fréquents en matière d'indemnités kilométriques est{" "}
                <strong>l'oubli de trajets</strong>. Un déplacement non noté, c'est une déduction
                ...
                l'absence de justificatifs peut entraîner un <strong>redressement fiscal</strong>{" "}
                portant sur l'ensemble des frais déclarés.
              </p>
              <h3 className="text-xl font-semibold mt-6 mb-3">
                Un suivi automatisé pour un dossier fiscal solide
              </h3>
              <p>
                C'est pourquoi un outil de suivi automatisé comme IKtracker devient un allié
                stratégique : il enregistre chaque déplacement en temps réel grâce au{" "}
                <Link to="/mode-tournee" className="text-primary hover:underline">
                  mode tournée GPS
                </Link>
                , calcule automatiquement les distances via Google Maps, et applique instantanément
                le barème kilométrique 2026 en vigueur. Le relevé généré est directement exploitable
                par votre comptable ou lors de votre{" "}
                <a
                ...
                . La{" "}
                <Link to="/calendrier" className="text-primary hover:underline">
                  synchronisation avec votre calendrier
                </Link>{" "}
                Google ou Outlook complète le dispositif. Plutôt que de reconstituer vos trajets en
                fin d'année à partir de souvenirs approximatifs, vous constituez un{" "}
                <strong>dossier fiscal solide</strong> au fil de l'eau, conforme aux exigences de
                l'URSSAF et du fisc.
              </p>
            </div>
          </section>
            ...
            <div className="container mx-auto max-w-4xl">
              <div className="text-center mb-8">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  Depuis 2021 et confirmé pour les <strong>indemnités kilométriques 2026</strong>,
                  les véhicules 100% électriques bénéficient d'un avantage fiscal significatif.
                </p>
              </div>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center gap-3 p-3 rounded-lg bg-white/60 dark:bg-black/20">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Sur le montant total calculé avec le barème
                        </p>
                      </div>
                    </div>
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          S'applique aux véhicules <strong>exclusivement électriques</strong>
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-4 w-4 text-emerald-600 dark:text-emerald-400 mt-0.5 shrink-0" />
                  ...
                  <CardContent className="space-y-4">
                    <p className="text-sm">
                      <strong className="text-amber-700 dark:text-amber-400">
                        Les véhicules hybrides et hybrides rechargeables ne bénéficient PAS de la
                        majoration de 20%.
                      </strong>
                    </p>
                      ...
                      <div className="flex items-center gap-3 p-2 rounded-lg bg-red-100/60 dark:bg-red-900/20 border border-red-200 dark:border-red-800">
                        ...
                        <div className="text-sm">
                          ...
                          <p className="text-muted-foreground text-xs">
                            Barème standard, pas de majoration
                          </p>
                        </div>
                      </div>
                      <div className="flex items-center gap-3 p-2 rounded-lg bg-red-100/60 dark:bg-red-900/20 border border-red-200 dark:border-red-800">
                    ...
                    <p className="text-xs text-muted-foreground mt-3">
                      Ces véhicules utilisent le barème classique car ils disposent d'un moteur
                      thermique, même partiel.
                    </p>
                  </CardContent>
                </Card>
              </div>
              ...
              <Card className="mt-6 border-blue-500/20 bg-blue-50/50 dark:bg-blue-950/20">
                <CardContent className="p-4 flex items-start gap-3">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="text-muted-foreground">
                      Que vous rouliez à l'essence, au diesel ou au GPL, le calcul des{" "}
                      <strong>indemnités kilométriques 2026</strong> reste identique. Seuls les
                      véhicules 100% électriques bénéficient d'un traitement fiscal avantageux avec
                      la majoration de 20%.
                    </p>
                    <a
            ...
            <div className="container mx-auto max-w-4xl">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <p>
                      Les indemnités kilométriques (IK) permettent de{" "}
                      <strong>
                        déduire de vos revenus les frais liés à l'utilisation de votre véhicule
                        personnel
                      </strong>{" "}
                      pour des déplacements professionnels.
                    </p>
                    <p>Le calcul tient compte de :</p>
                    <ul className="space-y-2">
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-4 w-4 text-success mt-0.5 shrink-0" />
                        <span>
                          La <strong>puissance fiscale</strong> de votre véhicule (en CV)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-4 w-4 text-success mt-0.5 shrink-0" />
                        <span>
                          La <strong>distance totale parcourue</strong> sur l'année
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-4 w-4 text-success mt-0.5 shrink-0" />
                        <span>
                          Le <strong>barème fiscal officiel</strong> publié chaque année
                        </span>
                      </li>
                    </ul>
                  </CardContent>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <p>Les indemnités kilométriques concernent principalement :</p>
                    <ul className="space-y-2">
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-4 w-4 text-success mt-0.5 shrink-0" />
                        <span>
                          <strong>Salariés</strong> optant pour les frais réels plutôt que
                          l'abattement de 10%
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-4 w-4 text-success mt-0.5 shrink-0" />
                        <span>
                          <strong>Indépendants et freelances</strong> (BNC, BIC)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-4 w-4 text-success mt-0.5 shrink-0" />
                        <span>
                          <strong>Dirigeants de société</strong> utilisant leur véhicule personnel
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-4 w-4 text-success mt-0.5 shrink-0" />
                        <span>
                          <strong>Bénévoles associatifs</strong> en déplacement
                        </span>
                      </li>
                    </ul>
                  </CardContent>
