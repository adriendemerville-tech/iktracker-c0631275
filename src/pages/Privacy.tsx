...
const PAGE_LASTMOD = getStaticLastModified("/privacy");
      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            description:
              "Politique de confidentialité et protection des données personnelles de l'application IKtracker",
        ...
        <article className="prose prose-sm dark:prose-invert max-w-none space-y-6">
          <section aria-labelledby="section-intro">
            ...
            <p className="text-muted-foreground">
              IKtracker s'engage à protéger la vie privée de ses utilisateurs. Cette politique de
          ...
          <section aria-labelledby="section-usage">
            <h2 id="section-usage" className="text-lg font-semibold text-foreground">
          ...
          <section aria-labelledby="section-security">
            <h2 id="section-security" className="text-lg font-semibold text-foreground">
              4. Stockage et sécurité
            </h2>
            <p className="text-muted-foreground">
              Vos données sont stockées de manière sécurisée sur des serveurs protégés. Nous
              utilisons le chiffrement et d'autres mesures de sécurité pour protéger vos
              informations contre tout accès non autorisé.
            </p>
          </section>

          <section aria-labelledby="section-sharing">
            <h2 id="section-sharing" className="text-lg font-semibold text-foreground">
              5. Partage des données
            </h2>
            <p className="text-muted-foreground">
              Nous ne vendons, n'échangeons ni ne transférons vos informations personnelles à des
              tiers, sauf si cela est nécessaire pour fournir nos services ou si la loi l'exige.
            </p>
          </section>

          <section aria-labelledby="section-rights">
            <h2 id="section-rights" className="text-lg font-semibold text-foreground">
              6. Vos droits
            </h2>
            <p className="text-muted-foreground">
          ...
          <section aria-labelledby="section-cookies">
            <h2 id="section-cookies" className="text-lg font-semibold text-foreground">
              7. Cookies
            </h2>
            <p className="text-muted-foreground">
          ...
          <section aria-labelledby="section-contact">
            ...
            <p className="text-muted-foreground">
              ...
              droits, veuillez nous contacter via le formulaire de feedback dans l'application.
            </p>
          </section>
