      ...
      >
        ...
        <article className="prose prose-sm dark:prose-invert max-w-none space-y-6">
          ...
          <section aria-labelledby="ml-directeur">
            <h2 id="ml-directeur" className="text-lg font-semibold text-foreground">
          ...
          <section aria-labelledby="ml-hebergeur">
            <h2 id="ml-hebergeur" className="text-lg font-semibold text-foreground">
              3. Hébergement
            </h2>
            <p className="text-muted-foreground">Le site est hébergé par :</p>
            <ul className="list-none pl-0 text-muted-foreground space-y-1">
              <li>
                <strong>Front-end :</strong> Netlify, Inc. — 44 Montgomery Street, Suite 300, San
                Francisco, CA 94104, USA
              </li>
              <li>
                <strong>Base de données :</strong> Supabase, Inc. — 970 Toa Payoh North, #07-04,
                Singapore 318992
              </li>
              <li>
                <strong>CDN / DNS :</strong> Cloudflare, Inc. — 101 Townsend St, San Francisco, CA
                94107, USA
              </li>
            </ul>
            <p className="text-muted-foreground text-sm mt-2">
              Les données sont stockées sur des serveurs situés dans l'Union européenne (région AWS
              eu-west).
            </p>
          </section>

          <section aria-labelledby="ml-pi">
            <h2 id="ml-pi" className="text-lg font-semibold text-foreground">
              4. Propriété intellectuelle
            </h2>
            <p className="text-muted-foreground">
              L'ensemble du contenu du site iktracker.fr (textes, images, graphismes, logo, icônes,
              logiciels) est la propriété exclusive de l'éditeur ou de ses partenaires et est
              protégé par les lois françaises et internationales relatives à la propriété
              intellectuelle. Toute reproduction, représentation, modification ou exploitation non
              autorisée est interdite.
            </p>
          </section>

          <section aria-labelledby="ml-donnees">
            <h2 id="ml-donnees" className="text-lg font-semibold text-foreground">
          ...
          <section aria-labelledby="ml-cookies">
            <h2 id="ml-cookies" className="text-lg font-semibold text-foreground">
              6. Cookies
            </h2>
            <p className="text-muted-foreground">
              IKtracker utilise uniquement des cookies essentiels au fonctionnement du service
              (authentification, préférences utilisateur). Aucun cookie publicitaire ou de tracking
              tiers n'est utilisé. Aucun consentement spécifique n'est donc requis au titre de la
              directive ePrivacy.
            </p>
          </section>

          <section aria-labelledby="ml-responsabilite">
            <h2 id="ml-responsabilite" className="text-lg font-semibold text-foreground">
              7. Limitation de responsabilité
            </h2>
            <p className="text-muted-foreground">
              IKtracker est un outil d'aide au calcul des indemnités kilométriques. Les résultats
              fournis sont basés sur le barème fiscal officiel mais ne constituent pas un conseil
              fiscal. L'utilisateur reste seul responsable de ses déclarations auprès de
              l'administration fiscale.
            </p>
          </section>

          <section aria-labelledby="ml-droit">
            <h2 id="ml-droit" className="text-lg font-semibold text-foreground">
              8. Droit applicable
            </h2>
            <p className="text-muted-foreground">
              Les présentes mentions légales sont régies par le droit français. Tout litige relatif
              à l'utilisation du site iktracker.fr sera soumis à la compétence exclusive des
              tribunaux français.
            </p>
            <p className="text-muted-foreground mt-4 text-sm">Dernière mise à jour : avril 2026</p>
          </section>

          {/* Founder section */}
          <section className="mt-12 pt-8 border-t border-border" aria-labelledby="ml-founder">
            <h2 id="ml-founder" className="sr-only">
              ...
              <figure className="flex flex-col sm:flex-row gap-4 items-center sm:items-start">
                ...
                <figcaption className="text-center sm:text-left">
                  <blockquote className="text-sm text-muted-foreground leading-relaxed italic">
                    ...
                    IKtracker pour mon usage professionnel."
                  </blockquote>
