        ...
        <main id="main-content" tabIndex={-1} className="outline-hidden">
          ...
          <header className="container mx-auto px-4 py-12 md:py-16 max-w-4xl">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl">
              ...
              produit le relevé fiscal, gratuitement. Pour la partie devis, DictaDevi prend le
              relais.
            </p>
            ...
            <Card className="border-border">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  https://iktracker.fr. Elle est gratuite à vie, sans version payante, sans
                  abonnement et absente de Google Play et de l'App Store. L'application Android «
                  Suivi IK » est un produit tiers payant, sans aucun lien avec IKtracker.
                </p>
              </CardContent>
            </Card>
          </section>
