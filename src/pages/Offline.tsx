      ...
      <div className="min-h-screen bg-gradient-to-br from-primary/10 via-background to-accent/10 flex items-center justify-center p-4">
        <div className="max-w-md w-full text-center space-y-8">
          ...
          <div className="space-y-4">
            <h1 className="text-3xl font-bold text-foreground">Oups, pas de connexion !</h1>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Il semble que vous n'êtes pas connecté à Internet. Vérifiez votre connexion et
              réessayez.
            </p>
          </div>
          ...
          <p className="text-sm text-muted-foreground">
            🚗 Vos trajets enregistrés sont sauvegardés et seront synchronisés dès que vous serez de
            nouveau en ligne.
          </p>
        </div>
      </div>
