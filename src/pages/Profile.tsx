...
// Lazy load chart component to avoid loading recharts on initial bundle
const KmChart = lazy(() => import('@/components/KmChart'));
        ...
        <Card className="relative">
          ...
          <CardContent>
            <Suspense fallback={<ChartPlaceholder />}>
              <KmChart monthlyKmData={monthlyKmData} chartMaxKm={chartMaxKm} />
            </Suspense>
          </CardContent>
        </Card>
