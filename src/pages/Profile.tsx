...
import { ArrowLeft, User, CreditCard, Settings, Moon, Sun, Mail, LogOut, Clock, Timer, MapPin, Briefcase, Car, Plus, Shield, ChevronRight, Send, ChevronDown, Route, Download, Share2, UserCircle, Home } from 'lucide-react';
...
import { KilometersChartSkeleton } from '@/components/KilometersChartSkeleton';
import { Vehicle, Location } from '@/types/trip';

// Lazy load the chart component to avoid loading recharts on initial page load
const KilometersChart = lazy(() => import('@/components/KilometersChart').then(m => ({ default: m.KilometersChart })));
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background cursor-default md:pl-16">
        ...
        {/* Kilometers Chart - Lazy loaded */}
        <Suspense fallback={<KilometersChartSkeleton />}>
          <KilometersChart trips={trips} isMobile={isMobile} />
        </Suspense>
