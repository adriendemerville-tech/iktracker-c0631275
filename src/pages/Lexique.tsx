...
export default function Lexique() {
  ...
  const renderDefinitionWithLinks = useCallback(
    (definition: string, currentTerm: string) => {
...
<body>
  ...
  const jsonLd = {
    ...
    description:
      "Dictionnaire complet des termes, acronymes et concepts liés aux indemnités kilométriques pour les indépendants et professions libérales en France.",
    inLanguage: "fr",
        ...
        <main className="container mx-auto px-4 py-12">
          ...
          <section className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto mb-6">
              Tous les termes, acronymes, acteurs et concepts liés aux frais kilométriques pour les{" "}
              <strong>indépendants</strong>, <strong>professions libérales</strong> et{" "}
              <strong>artisans</strong> en France, expliqués simplement.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <Button
                ...
                onClick={() => {
                  ...
                  const text =
                    "Lexique complet des indemnités kilométriques en France 2026 : tous les termes expliqués simplement pour les indépendants et professions libérales.";
                  window.open(
                ...
                return (
                  ...
                  >
                    <div className="flex flex-wrap items-start gap-3 mb-3">
                      <h3 className="text-xl font-bold text-foreground" itemProp="name">
                        {term.term}
                      </h3>
                      <span
                        className={`text-xs px-2 py-1 rounded-full font-medium ${categoryColors[term.category]}`}
                      >
                      ...
                      <button
                        ...
                        title={
                          favorites.has(termSlug) ? "Retirer des favoris" : "Ajouter aux favoris"
                        }
                        aria-label={
                          favorites.has(termSlug)
                            ? `Retirer ${term.term} des favoris`
                            : `Ajouter ${term.term} aux favoris`
                        }
                      >
                        <Star
                          className={`h-4 w-4 ${favorites.has(termSlug) ? "fill-current" : ""}`}
                        />
                      </button>
                      <button
          ...
          <section className="mt-16 text-center bg-primary/5 rounded-2xl p-8 md:p-12">
            ...
            <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
              Utilisez IKtracker pour automatiser le calcul de vos IK selon le barème 2026, générer
              des justificatifs fiscaux et optimiser vos frais réels.
            </p>
            <Link to="/auth">
