        ...
        <main id="main-content" tabIndex={-1} className="outline-hidden">
          ...
          <header className="container mx-auto px-4 py-12 md:py-16 max-w-4xl">
            ...
            <p className="text-lg text-muted-foreground mb-4 max-w-2xl">
              ...
              mangent pourtant ses soirées : chiffrer les devis, justifier les déplacements et
              rester visible. Trois outils spécialisés suffisent à les absorber.
            </p>
          ...
          <section className="container mx-auto px-4 py-12 max-w-5xl">
            <h2 className="text-2xl md:text-3xl font-bold mb-8">
              Où partent les heures non facturées
            </h2>
            ...
            <Card className="border-primary/30 bg-muted/30">
              <CardContent className="p-6 md:p-10">
                ...
                <p className="text-muted-foreground mb-6 max-w-3xl">
                  ...
                  artisan et suit la marge du chantier. Le devis part pendant que le client est
                  encore dans l'intention d'achat.
                </p>
          ...
          <section className="container mx-auto px-4 py-12 max-w-5xl">
            ...
            <p className="text-muted-foreground mb-8 max-w-2xl">
              Visite technique, dépôt, SAV, rendez-vous client : un artisan enchaîne les
              déplacements. Sans relevé tenu, ces kilomètres ne sont ni déduits ni défendables en
              cas de contrôle.
            </p>
            <div className="grid gap-4 md:grid-cols-3">
              {[
          ...
          <section className="container mx-auto px-4 py-16 max-w-3xl text-center">
            ...
            <p className="text-muted-foreground mb-8">
              IKtracker est gratuit à vie. Créez votre compte, laissez les kilomètres se compter
              seuls, puis outillez le chiffrage et la visibilité.
            </p>
