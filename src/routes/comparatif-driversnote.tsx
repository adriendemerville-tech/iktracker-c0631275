  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "keywords",
        content:
          "driversnote alternative, driversnote gratuit, ibeacon frais kilométriques, mouchard gps voiture, alternative driversnote france, suivi kilométrique sans gps",
      },
      {
        property: "og:title",
      ...
      },
      {
        ...
        content:
          "Comparatif 2026 : Le tracking GPS automatique vs la synchronisation d'agenda intelligente. Alternative gratuite et respectueuse de la vie privée.",
      },
      ...
      { name: "twitter:title", content: "Alternative Driversnote Gratuite 2026" },
      {
        ...
        content:
          "Driversnote trop cher ? Découvrez IKtracker, l'alternative sans GPS permanent et 100% gratuite.",
      },
      { name: "geo.region", content: "FR" },
      { name: "geo.placename", content: "France" },
      { name: "language", content: "fr" },
    ],
    links: [{ rel: "canonical", href: "https://iktracker.fr/comparatif-driversnote" }],
  }),
