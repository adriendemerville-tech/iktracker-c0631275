...
export const Route = createFileRoute("/installer")({
  head: () => ({
    meta: [
      ...
      {"property":"og:description","content":"Installez librement IKtracker sur votre smartphone iOS ou Android en 2 minutes. Outil professionnel PWA gratuit, sans App Store."},
      ...
      {"name":"twitter:description","content":"Installez librement IKtracker sur votre smartphone iOS ou Android en 2 minutes. Outil professionnel PWA gratuit, sans App Store."},
    ...
    links: [
      {"rel":"canonical","href":"https://iktracker.fr/installer"},
    ],
  }),
  component: Install,
});
