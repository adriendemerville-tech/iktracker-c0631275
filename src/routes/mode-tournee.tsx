...
export const Route = createFileRoute("/mode-tournee")({
  head: () => ({
    meta: [
      ...
      {"property":"og:description","content":"Mode Tournée IKtracker : enregistrez gratuitement tous vos arrêts clients grâce à la localisation GPS. Outil professionnel pour infirmiers libéraux, artisans et commerciaux."},
      ...
      {"name":"twitter:title","content":"Mode Tournée IKtracker | Suivi kilométrique multi-arrêts"},
      {"name":"twitter:description","content":"Mode Tournée IKtracker : enregistrez gratuitement tous vos arrêts clients grâce à la localisation GPS. Outil professionnel pour infirmiers libéraux, artisans et commerciaux."},
    ...
    links: [
      {"rel":"canonical","href":"https://iktracker.fr/mode-tournee"},
    ],
  }),
