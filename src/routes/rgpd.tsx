  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "keywords",
        content:
          "RGPD, protection données personnelles, conformité RGPD, droits utilisateurs, CNIL, IKtracker, données trajets",
      },
      ...
      { property: "og:title", content: "RGPD — Protection des données personnelles | IKtracker" },
      {
        ...
        content:
          "Conformité RGPD totale d'IKtracker. Exercez vos droits d'accès, rectification, effacement et portabilité en toute simplicité.",
      },
      ...
      { name: "twitter:title", content: "RGPD — Protection des données personnelles | IKtracker" },
      {
        ...
        content: "Conformité RGPD totale d'IKtracker. Exercez vos droits en toute simplicité.",
      },
    ],
    links: [{ rel: "canonical", href: "https://iktracker.fr/rgpd" }],
  }),
  component: Rgpd,
});
