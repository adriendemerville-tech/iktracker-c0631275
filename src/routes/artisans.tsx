  ...
  head: () => ({
    meta: [
      ...
      },
      {
        ...
        content:
          "IKtracker calcule vos frais kilométriques de chantier au barème officiel, gratuitement. DictaDevi transforme votre voix en devis.",
      },
      ...
      { name: "twitter:title", content: "Frais kilométriques artisan : calcul barème 2026 et trajets de chantier" },
      {
        ...
        content:
          "Calcul automatique des frais kilométriques de chantier au barème officiel, gratuit, et devis dictés à la voix avec DictaDevi.",
      },
      { name: "geo.region", content: "FR" },
      { name: "language", content: "fr" },
    ],
    links: [{ rel: "canonical", href: "https://iktracker.fr/artisans" }],
  }),
  component: Artisans,
});
