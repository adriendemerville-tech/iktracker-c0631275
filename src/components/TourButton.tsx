  ...
  return (
    <button
      ...
      className={cn(
        ...
        "transition-all duration-[2000ms] ease-[cubic-bezier(0.4,0,0.1,1)]",
        isActive
    ...
    >
      ...
      <span className={cn(
        "absolute left-2.5 top-1/2 -translate-y-1/2 flex flex-col gap-1.5 transition-opacity duration-[2000ms] ease-[cubic-bezier(0.4,0,0.1,1)] z-10",
      ...
      <Car 
        className={cn(
          "w-7 h-7 relative z-10 transition-colors duration-[2000ms] ease-[cubic-bezier(0.4,0,0.1,1)]",
