  ...
  return (
    <button
      ...
      className={cn(
        ...
        isActive ? "focus:ring-[#25D366]/50" : "focus:ring-primary/50 hover:scale-105",
    ...
    >
      ...
      {isActive && displayDistance > 0 && (
        <span className="absolute -bottom-1 -left-1 min-w-5 h-5 px-1 bg-[#25D366] text-white text-xs rounded-full flex items-center justify-center font-bold shadow-md z-[20]">
          {displayDistance}
        </span>
      )}
    </button>
