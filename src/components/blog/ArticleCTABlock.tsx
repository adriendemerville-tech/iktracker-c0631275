...
export function ArticleCTABlock() {
  return (
    <aside className="my-12 rounded-2xl border border-border bg-muted/40 p-6 md:p-8">
      <h2 className="text-xl md:text-2xl font-bold text-foreground mb-2">Passez à l'action</h2>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="rounded-xl border border-border bg-background p-5 flex flex-col">
          ...
          <p className="text-sm text-muted-foreground mb-4 flex-1">
            Calculez vos indemnités kilométriques 2026 selon le barème officiel et exportez votre
            relevé pour la déclaration de revenus.
          </p>
        ...
        <div className="rounded-xl border border-border bg-background p-5 flex flex-col">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="font-semibold text-foreground">
              Commercial, libéral, profession mobile
            </h3>
          </div>
          <p className="text-sm text-muted-foreground mb-4 flex-1">
            Démarrez votre tournée GPS automatique : IKtracker enregistre chaque arrêt et génère
            votre note de frais kilométrique.
          </p>
