...
export const RESOURCE_LABELS: Record<string, { icon: typeof FileText; label: string }> = {
...
export const SEVERITY_CONFIG: Record<string, { icon: typeof Info; color: string; bg: string }> = {
...
// Health dashboard
export function HealthDashboard({ events }: { events: AutopilotEvent[] }) {
