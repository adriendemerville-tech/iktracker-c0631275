...
export function Counter({ value, label, unit, variant = "default", decimals = 0 }: CounterProps) {
  ...
  return (
    ...
    >
      <span className="text-[9px] sm:text-xs uppercase tracking-wider text-muted-foreground mb-1 sm:mb-2 font-urbanist font-medium">
        {label}
      </span>
      <div className="flex items-baseline gap-0.5 sm:gap-1.5">
        ...
        <span className="text-[10px] sm:text-sm font-urbanist font-semibold text-muted-foreground">
          {unit}
        </span>
      </div>
    </div>
