...
export const IKSimulator = ({
  ...
  const simulation = useMemo(() => {
    ...
    const electricBonus = isElectric ? totalIK * 0.2 : 0;
  ...
  return (
    <div className={className}>
      <div className="text-center mb-8">
        <h2 id={`simulateur${idSuffix}`} className="text-2xl md:text-3xl font-bold mb-4">
          {title}
        </h2>
        ...
        <CardContent className="p-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div>
                <Label htmlFor={fpId} className="text-sm font-medium">
              ...
              <div>
                <Label htmlFor={kmId} className="text-sm font-medium">
              ...
              <div className="flex items-center justify-between p-3 rounded-lg bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <Label htmlFor={evId} className="text-sm font-medium cursor-pointer">
            ...
            <div
              className={`rounded-xl p-6 flex flex-col justify-center ${isElectric ? "bg-gradient-to-br from-emerald-500/10 to-emerald-600/20" : "bg-gradient-to-br from-primary/5 to-primary/10"}`}
            >
              ...
              <p
                className={`text-4xl font-bold mb-4 ${isElectric ? "text-emerald-600 dark:text-emerald-400" : "text-primary"}`}
              >
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    Barème applicable : <strong>{simulation.bracket}</strong>
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="h-4 w-4 text-success" />
                  <span>
                    Taux de base : <strong>{simulation.rate.toFixed(3)} €/km</strong>
                  </span>
                </div>
                {isElectric && (
                  <div className="flex items-center gap-2 text-emerald-600 dark:text-emerald-400">
                    ...
                    <span>
                      ...
                      <strong>
                        +
                        {simulation.electricBonus.toLocaleString("fr-FR", {
                          style: "currency",
                          currency: "EUR",
                          maximumFractionDigits: 0,
                        })}
          ...
          <div className="mt-6 pt-6 border-t border-border text-center">
            ...
            <Link to="/signup" onClick={trackCTAClick}>
              <Button variant="gradient" size="lg" className="gap-2">
                Automatiser mes{" "}
                {simulation.totalWithBonus.toLocaleString("fr-FR", { maximumFractionDigits: 0 })} €
                d'IK
