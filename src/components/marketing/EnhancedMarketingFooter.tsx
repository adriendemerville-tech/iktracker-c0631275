...
const faqItems = [
  {
    ...
    answer:
      "Oui, IKtracker est 100% gratuit et le restera. Aucune carte bancaire n'est requise, aucun abonnement caché. Toutes les fonctionnalités sont accessibles : enregistrement illimité des trajets, calcul automatique des IK, export PDF et CSV.",
  },
  {
    question: "Comment fonctionne le calcul des indemnités kilométriques ?",
    answer:
      "IKtracker applique automatiquement le barème fiscal officiel 2026 selon la puissance fiscale de votre véhicule et les kilomètres parcourus. Le calcul intègre les 3 tranches (jusqu'à 5000 km, 5001-20000 km, au-delà) et la majoration de 20% pour les véhicules électriques.",
  },
  {
    question: "Puis-je utiliser IKtracker sur iPhone ou Android ?",
    answer:
      "Oui, IKtracker est une Progressive Web App (PWA) installable sur tous les smartphones. Elle fonctionne hors-ligne et utilise le GPS pour enregistrer vos trajets automatiquement, même sans connexion internet.",
  },
  {
    question: "Comment synchroniser mon calendrier Google ou Outlook ?",
    answer:
      "Connectez votre agenda en quelques clics depuis les paramètres. IKtracker importe automatiquement vos rendez-vous professionnels et crée les trajets correspondants avec calcul des distances et indemnités.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Oui, IKtracker est idéal pour les IDEL et professionnels de santé à domicile. Le mode tournée permet d'enregistrer plusieurs patients en une seule session avec calcul optimisé des distances.",
  },
  {
    question: "Comment exporter mes trajets pour ma comptabilité ?",
    answer:
      "Générez un relevé PDF ou CSV en quelques clics depuis l'onglet 'Mes trajets'. Le document inclut toutes les informations requises par l'administration fiscale : dates, distances, montants IK, véhicule utilisé.",
  },
  {
    question: "Quelle est la différence avec un carnet de bord papier ?",
    answer:
      "IKtracker automatise le calcul des distances via GPS, applique le barème fiscal correct, et génère des exports professionnels. Fini les erreurs de calcul, les oublis de trajets et les heures perdues en saisie manuelle.",
  },
];
...
export function EnhancedMarketingFooter() {
  ...
  const professionLinks = [
    ...
    { label: "Commercial itinérant", href: "/blog/indemnites-kilometriques-commercial-itinerant" },
    {
      ...
      href: "/blog/indemnites-kilometriques-consultant-independant",
    },
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 md:gap-12">
            ...
            <div className="col-span-2 md:col-span-4 lg:col-span-1">
              ...
              <p className="text-sm text-muted-foreground mb-4 max-w-xs">
                Outil professionnel gratuit pour automatiser le calcul de vos indemnités
                kilométriques. Conforme au barème fiscal 2026.
              </p>
              <div
              ...
              >
                ...
                <span
                  className="text-xs bg-accent/10 text-accent-foreground px-3 py-1 rounded-full"
                  role="listitem"
                >
                  RGPD
                </span>
          ...
          <div className="mt-10 pt-8 border-t border-border/50">
            <p className="text-sm text-muted-foreground">
              ...
              <span className="font-medium text-foreground">
                {" "}
                IKtracker est disponible partout en France, gratuitement.
              </span>
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-muted-foreground text-center md:text-left">
              © {currentYear} IKtracker. Outil professionnel gratuit de calcul des indemnités
