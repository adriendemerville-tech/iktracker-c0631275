      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-8 md:mb-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-sm md:text-base text-muted-foreground mb-4 max-w-sm">
              L'outil gratuit et français pour automatiser vos indemnités kilométriques. Conçu pour
              les infirmiers, artisans et consultants.
            </p>
            <div
          ...
          <nav aria-labelledby="footer-product-heading">
            <h2 id="footer-product-heading" className="font-semibold text-foreground mb-4">
              Produit
            </h2>
          ...
          <nav aria-labelledby="footer-resources-heading">
            <h2 id="footer-resources-heading" className="font-semibold text-foreground mb-4">
              Ressources
            </h2>
            <ul className="space-y-3" role="list">
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground text-center md:text-left">
            © {currentYear} IKtracker. Application gratuite de gestion des indemnités kilométriques
            pour indépendants en France.
          </p>
