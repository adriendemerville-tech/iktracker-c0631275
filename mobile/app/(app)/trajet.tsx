  ...
  const onSave = useCallback(async () => {
    ...
    try {
      const trip = await createTrip({
        ...
        startAddress:
          finished.start.address ??
          `${finished.start.lat.toFixed(5)}, ${finished.start.lng.toFixed(5)}`,
        endAddress:
          finished.end.address ?? `${finished.end.lat.toFixed(5)}, ${finished.end.lng.toFixed(5)}`,
      });
        ...
        {live && (
          <>
            ...
            <Text style={styles.address}>
              {live.start.address ?? "Adresse en cours de résolution"}
            </Text>
          </>
        )}
        {finished && (
