-- Update get_user_stats to include page views count
...
BEGIN
  ...
  -- Get page views count for this user
  SELECT COUNT(*) INTO user_page_views
  ...
  result := json_build_object(
    ...
    'tour_pct', tour_pct,
    -- Page views
    'page_views', COALESCE(user_page_views, 0)
  );
