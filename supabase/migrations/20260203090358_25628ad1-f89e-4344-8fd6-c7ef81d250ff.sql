...
-- Redefine get_user_stats to count unique active days from real user activity
...
BEGIN
  ...
  FROM (
    ...
    UNION
    -- Days with marketing analytics (if any)
    ...
    UNION
    -- Days with calendar connection activity
  ...
  result := json_build_object(
    ...
    'tour_pct', tour_pct,
    -- Active days (renamed from page_views)
