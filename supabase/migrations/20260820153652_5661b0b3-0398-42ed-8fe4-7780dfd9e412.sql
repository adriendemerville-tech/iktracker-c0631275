...
SELECT cron.schedule(
  'content-freshness-audit-daily',
  '0 6 * * *',
  $$
  SELECT net.http_post(
    url := 'https://project--5bbd6f17-49e4-4066-9f35-29e062baefea.lovable.app/api/public/content-freshness-audit',
