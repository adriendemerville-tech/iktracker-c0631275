  ...
  <Html lang="fr" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Hr style={hr} />
        <Text style={footer}>
          Les liens ci-dessus sont sécurisés et expirent dans {expiresLabel}.
          Ce relevé est basé sur les trajets enregistrés dans IKtracker et
          calculé selon le barème officiel de l'administration fiscale.
        </Text>
      </Container>
    </Body>
  </Html>
...
export const template = {
  component: Email,
  subject: (data: Props) =>
    `Relevé kilométrique — ${data?.periodLabel ?? 'Période écoulée'}`,
